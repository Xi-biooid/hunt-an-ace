...
const cardObjectDefinitions = [
    {id:1, imagePath:'cards/ace-heart.png'},
    {id:2, imagePath:'cards/ace-club.png'},
    {id:3, imagePath:'cards/ace-diamond.png'},
    {id:4, imagePath:'cards/ace-spade.png'}
]
const aceId = 4
...
const hexCode  = "&#8667";
const hexCode2  = "&#129321";
const hexCode3  = "&#129395";
const hexCode4 = "&#129315";
const hexCode5 = "	&#129323";
const hexCode6 = "	&#128576";
function gameOver()
{
    updateStatusElement(scoreContainerElem,"none")
    updateStatusElement(roundContainerElem,"none")

    const gameOverMessage = `Game Over! Final Score ${hexCode} <span class = 'badge'>${score}</span> Wanna hung again? let's hunt ${hexCode2} `
...
{
    calculateScore()
    updateStatusElement(scoreElem, "block", primaryColor, `Score <span class='badge'> ${hexCode} ${score}</span>`)
...
function outputChoiceFeedBack(hit)
{
    if(hit)
    {
        updateStatusElement(currentGameStatusElem, "block", winColor, `Hit!! - Well Done!! ${hexCode3}` )
    }
    else
    {
        updateStatusElement(currentGameStatusElem, "block", loseColor,  `OOPS ${hexCode4} You Missed!! `)
    }
}
...
function initializeNewGame(){
    ...
    updateStatusElement(scoreElem,"block",primaryColor,`Score <span class='badge'>  ${hexCode} ${score}</span>`)
    updateStatusElement(roundElem,"block",primaryColor,`Round <span class='badge'>  ${hexCode} ${roundNum}</span>`)
...
function shuffleCards()
{
    ...
    function shuffle()
    {
        ...
        if(shuffleCount == 500)
        {
            ...
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, ` ${hexCode5} shshsh..  Target locked click the card that you think is the Ace of Spades`)
